...
//const URL_LOGO_QR = "logo-horisontal.png";


const tglIndonesiaOpsi = { //--- KONVERSI WAKTU KE LOCAL TIME INDONESIA
	day: '2-digit',
	month: 'long',
	year: 'numeric',
	hour: '2-digit',
	minute: '2-digit',
	second: '2-digit',
	timeZone: 'Asia/Jakarta', //--> Memastikan waktu dihitung berdasarkan zona WIB
	...
	try {
		...
		for (let i = 0; i < positions.length; i++) {
			try {
				...
				// 1. Ekstraksi OID (Object Identifier) dari objek SignerInfo
				...
				try {
					// 1. Ambil seluruh sertifikat dari objek SignedData (sd)
					const globalCerts = sd.certificates || [];

					// 2. Lakukan Deep Scan pada rantai sertifikat
					...
					// 3. Fallback: Jika melalui scan sertifikat tidak ditemukan, cek Unauthenticated Attributes
